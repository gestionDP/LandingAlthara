...
/**
 * 06 · Infraestructura — ALT-WEB-2026-01 §04.F.
 *
 * Plataforma propia (7+ años), data rooms y trazabilidad. Los cuatro puntos
 * se conservan tal cual: son buen copy. Se elimina el botón «Entrar al
 * portal» —el único botón del site vive en la sección 09—; el acceso de
 * inversores existentes queda como enlace de texto en el pie.
 */
    ...
    <section id="infraestructura" className="container-site scroll-mt-24 py-24 md:py-36">
      <div className="grid gap-12 md:grid-cols-12 md:gap-8">
        <div className="md:col-span-6">
          ...
          <h2 className="display-xl mt-6 text-3xl text-[#1c3742] md:text-4xl lg:text-5xl">
          ...
          <ul className="mt-10 space-y-5">
            {FEATURES.map((i) => (
              ...
              >
                <span className="label-mono shrink-0 text-[#c08552]">
                  {String(i + 1).padStart(2, '0')}
                </span>
                <div>
                  <p className="font-montserrat font-bold text-[#1c3742]">
                    {t(`features.${i}.title`)}
                  </p>
                  <p className="mt-1 text-sm leading-relaxed text-[#1c3742]/70">
                    {t(`features.${i}.text`)}
                  </p>
                </div>
              </motion.li>
